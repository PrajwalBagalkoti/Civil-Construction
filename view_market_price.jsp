...
<div>
    <center>
        <h1>view_market_price_Details</h1>
    ...
    <br>
            ...
            try
          {
            ...
            ResultSet rs=stmt.executeQuery("select * from market_price ");
            while(rs.next())
            {
      ...
      out.println("</td><td>");
        ...
        out.println("</td><td>");
          ...
          out.println("</td><td>");
            ...
            %>
            <a href="Update_market_price .jsp?num=<%=rs.getString(1)%>" >Update</a>
            <%
            out.println("</td><td>");
    %>
    <a href="delete_market_price.jsp?num=<%=rs.getString(1) %>">Delete</a>
    <%
    out.println("</td></tr>");
    %>
