...
<div>
    <center>
        <h1>view_upload_blue_print_Details</h1>
    ...
    <br>
            ...
            try
          {
            ...
            ResultSet rs=stmt.executeQuery("select * from  upload_blue_print");
            while(rs.next())
            {
    ...
    out.println("<tr><td>");
      ...
      out.println("</td><td>");
        ...
        out.println("</td><td>");
            ...
            %>
            <a href="Update_upload_blue_print.jsp?num=<%=rs.getString(1)%>" >Update</a>
            <%
            out.println("</td><td>");
    %>
    <a href="delete_upload_blue_print.jsp?num=<%=rs.getString(1) %>">Delete</a>
    <%
    out.println("</td></tr>");
    %>
