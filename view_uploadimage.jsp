...
<div>
    <center>
        <h1>view_uploadimage_Details</h1>
    ...
    <br>
            ...
            try
          {
            ...
            ResultSet rs=stmt.executeQuery("select * from  uploadimage");
            while(rs.next())
            {
    ...
    out.println("<tr><td>");
      ...
      out.println("</td><td>");
        ...
        out.println("</td><td>");
            ...
            %>
            <a href="Update_uploadimage.jsp?num=<%=rs.getString(1)%>" >Update</a>
            <%
            out.println("</td><td>");
    %>
    <a href="delete_uploadimage.jsp?num=<%=rs.getString(1) %>">Delete</a>
    <%
    out.println("</td></tr>");
    %>
