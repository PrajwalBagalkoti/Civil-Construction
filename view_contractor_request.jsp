...
<div>
    <center>
        <h1>view_contractor_request_Details</h1>
    ...
    <br>
            ...
            try
          {
            ...
            ResultSet rs=stmt.executeQuery("select * from contractor_request ");
            while(rs.next())
            {
      ...
      out.println("</td><td>");
        ...
        out.println("</td><td>");
          ...
          out.println("</td><td>");
            ...
            %>
            <a href="Update_contractor_request.jsp?num=<%=rs.getString(1)%>" >Update</a>
            <%
            out.println("</td><td>");
    %>
    <a href="delete_contractor_request.jsp?num=<%=rs.getString(1) %>">Delete</a>
    <%
    out.println("</td></tr>");
    %>
