...
<div>
    <center>
        <h1>View_Book_Request_Details</h1>
    ...
    <br>
            ...
            try
          {
            ...
            ResultSet rs=stmt.executeQuery("select * from book_request");
            while(rs.next())
            {
      ...
      out.println("</td><td>");
        ...
        out.println("</td><td>");
          ...
          out.println("</td><td>");
            ...
            %>
            <a href="Update_book_request.jsp?num=<%=rs.getString(1)%>" >Update</a>
            <%
            out.println("</td><td>");
    %>
    <a href="delete_book_request.jsp?num=<%=rs.getString(1) %>">Delete</a>
    <%
    out.println("</td></tr>");
    %>
