...
<div>
    ...
    <br>
            ...
            try
          {
            ...
            ResultSet rs=stmt.executeQuery("select * from add_labour");
            while(rs.next())
            {
      ...
      out.println("</td><td>");
        ...
        out.println("</td><td>");
          ...
          out.println("</td><td>");
            ...
            %>
            <a href="update_add_labour.jsp?num=<%=rs.getString(1)%>" >Update</a>
            <%
            out.println("</td><td>");
    %>
    <a href="delete_add_labour.jsp?num=<%=rs.getString(1) %>">Delete</a>
    <%
    out.println("</td></tr>");
    %>
